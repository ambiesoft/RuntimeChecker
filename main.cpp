...
RUNTIME_STRUCT runtimes[] =
{
	...
	{ FALSE, IDR_DLL_VC2002, TEXT("vc2002") },
	...
	{ FALSE, IDR_DLL_VC2015, TEXT("vc2015") },
	{ FALSE, IDR_DLL_VC2017, TEXT("vc2017") },
};
#else
RUNTIME_STRUCT runtimes[] =
{
	{ FALSE, IDR_DLL_VC2008_X64, TEXT("vc2008_x64") },
	{ FALSE, IDR_DLL_VC2010_X64, TEXT("vc2010_x64") },
	{ FALSE, IDR_DLL_VC2013_X64, TEXT("vc2013_x64") },
	{ FALSE, IDR_DLL_VC2015_X64, TEXT("vc2015_x64") },
	{ FALSE, IDR_DLL_VC2017_X64, TEXT("vc2017_x64") },
	{ FALSE, IDR_DLL_VC2019_X64, TEXT("vc2019_x64") },
};
#endif
	...
	case WM_RUNTIMECHECK:
		{
			...
			for (auto&item : runtimes)
			{
				if (CreateTempDirectory(szTempDirectoryPath))
				{
					PathAppend(szTempDirectoryPath, item.lpszRuntimeName);
					PathAddExtension(szTempDirectoryPath, TEXT(".dll"));
					if (CreateFileFromResource(MAKEINTRESOURCE(item.nResourceID),
	...
	case WM_PAINT:
		{
			...
			for (auto item : runtimes)
			{
				wsprintf(szText, TEXT("%s %s"), item.lpszRuntimeName,
					item.bIsInstalled ? TEXT("O") : TEXT("X"));
